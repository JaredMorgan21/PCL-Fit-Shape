  ...
  def listener_callback(self, msg):
    ...
    for j, indices in enumerate(cluster_indices):
        ...
        # Checks if cylinder fit is the highest
          ...
          # oreintation with respect to world frame
...
def make_cylinder(radius, length, center, orientation):
    ...
    # Check if the two vectors are within tolerance
    ...
    # Gets the rotation matrix for the points around the axis
